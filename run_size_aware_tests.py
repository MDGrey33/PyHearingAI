...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Run size-aware audio processing end-to-end tests"
    )
    ...
    group.add_argument("--size-constrained", action="store_true", help="Run only the size-constrained conversion test")
