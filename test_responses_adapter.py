...
def test_medium_audio(audio_path, duration=300):
    ...
    try:
        ...
        success = test_responses_adapter(
            audio_path=audio_path, output_path=output_path, start_time=start_time, end_time=end_time
        )
...
def main():
    ...
    parser.add_argument(
        "--duration", type=int, default=300, help="Duration in seconds for medium test"
    )
