...
class TestAudioValidationService:
    ...
    def test_validate_audio_file(self, mock_validate):
        ...
        is_valid, error_msg = AudioValidationService.validate_audio_file(
            file_path, ApiProvider.OPENAI_WHISPER
        )
    ...
    def test_estimate_optimal_chunk_duration(
        self, mock_get_limit, mock_getsize, mock_exists, example_audio_path
    ):
        ...
        duration = AudioValidationService.estimate_optimal_chunk_duration(
            example_audio_path, quality_spec, ApiProvider.OPENAI_WHISPER
        )
    ...
    @patch("os.path.getsize")
    @patch.object(ApiSizeLimitPolicy, "get_limit_for_provider")
    def test_suggest_quality_reduction(
        self, mock_get_limit, mock_getsize, mock_exists, example_audio_path
    ):
        ...
        result = AudioValidationService.suggest_quality_reduction(
            example_audio_path, current_spec, ApiProvider.OPENAI_WHISPER
        )
