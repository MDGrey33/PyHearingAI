    ...
    def test_reconcile_batched(self):
        ...
        for chunk in self.chunks:
            ...
            for i in range(3):
                ...
                mock_transcription_repo.get_segment_transcription.return_value = (
                    f"Transcription for {seg_key}"
                )
        ...
        batch_config = BatchConfig(
            batch_size_seconds=180, batch_overlap_seconds=10, max_tokens_per_batch=4000
        )
        ...
        with patch.object(service.adapter, "reconcile") as mock_reconcile:
            ...
            mock_reconcile.return_value = [
                Segment(start=0.0, end=5.0, text="Reconciled text", speaker_id="SPEAKER_00")
            ]
            ...
            self.assertEqual(
                mock_reconciliation_repo.save_reconciled_result.call_count, 3
            )  # Interim + final + metadata
