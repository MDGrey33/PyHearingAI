...
class FFmpegAudioFormatService(AudioFormatService):
    ...
    def get_audio_metadata(self, audio_path: Path) -> Dict[str, Any]:
        ...
        try:
            ...
            metadata = {
                ...
                if "bits_per_sample" in audio_info
                else None,
            }
    ...
    def extract_audio_segment(
        ...
        try:
            ...
            if (
                quality_spec
                and quality_spec.quality is not None
                and output_format in ["mp3", "ogg"]
            ):
    ...
    def detect_silence(
        ...
        try:
            ...
            silence_filter = f"silencedetect=noise={silence_threshold}dB:d={min_silence_duration}"

            # Build the full FFmpeg command
            cmd = ["ffmpeg", "-i", str(audio_path), "-af", silence_filter, "-f", "null", "-"]
